...
public class TenantController {
    ...
    @PreAuthorize("@perm.hasPerms('upms:tenant:signUp')")
    ...
    @PreAuthorize("@perm.hasPerms('upms:tenant:confirm')")
    ...
    @PreAuthorize("@perm.hasPerms('upms:tenant:save')")
    ...
    @PreAuthorize("@perm.hasPerms('upms:tenant:remove')")
    ...
    @PreAuthorize("@perm.hasPerms('upms:tenant:update')")
    ...
    @PreAuthorize("@perm.hasPerms('upms:tenant:get')")
    ...
    @PreAuthorize("@perm.hasPerms('upms:tenant:page')")
