...
public class ClientDetailsServiceImpl implements ClientDetailsService {
    ...
    private BaseClientDetails getBaseClient(OauthClientDetails oauthClientDetails) {
        ...
        baseClientDetails.setAdditionalInformation(JsonUtils.toMap(oauthClientDetails.getAdditionalInformation(), String.class, Object.class));
        // @formatter:on
    ...
    private OauthClientDetails getOauthClientDetails(BaseClientDetails baseClientDetails) {
        ...
        oauthClientDetails.setAdditionalInformation(JsonUtils.toJsonString(baseClientDetails.getAdditionalInformation()));
        // @formatter:on
