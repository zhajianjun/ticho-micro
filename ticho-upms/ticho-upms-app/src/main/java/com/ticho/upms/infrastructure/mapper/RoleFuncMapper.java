...
public interface RoleFuncMapper extends BaseMapper<RoleFunc> {
     ...
     * 批量保存 角色功能关联关系
     *
     * @param roleFuncs 角色功能关联关系 对象
     * @return int 数量
     */
    int insertBatch(@Param("ew") Collection<RoleFunc> roleFuncs);
     ...
     *
     * @param roleFuncs 角色功能关联关系
     * @return int 数量
     */
    int insertOrUpdate(RoleFunc roleFuncs);
     ...
     *
     * @param roleFuncs 角色功能关联关系 列表
     * @return int 数量
     */
    int insertOrUpdateBatch(@Param("ew") Collection<RoleFunc> roleFuncs);
     ...
     */
    List<RoleFunc> selectByConditions(RoleFuncQuery query);
