...
public interface RoleResMapper extends BaseMapper<RoleRes> {
     ...
     * 批量保存 角色和资源关联表
     *
     * @param roleRess 角色和资源关联表 对象
     * @return int 数量
     */
    int insertBatch(@Param("ew") Collection<RoleRes> roleRess);
     ...
     *
     * @param roleRess 角色和资源关联表
     * @return int 数量
     */
    int insertOrUpdate(RoleRes roleRess);
     ...
     *
     * @param roleRess 角色和资源关联表 列表
     * @return int 数量
     */
    int insertOrUpdateBatch(@Param("ew") Collection<RoleRes> roleRess);
     ...
     */
    List<RoleRes> selectByConditions(RoleResQuery query);
